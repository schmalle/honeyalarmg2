...
GRANT ALL PRIVILEGES ON honeyalarmdev.* TO 'honeyalarmdev'@'localhost' IDENTIFIED BY 'honeyalarmpw';
GRANT ALL PRIVILEGES ON honeyalarmprod.* TO 'honeyalarmprod'@'localhost' IDENTIFIED BY 'honeyalarmppw';
